...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="float-end mt-4 ms-4"> <a href="?log=logout">logout</a></div>
            <div class="float-end mt-4 ms-4">user : <a href="?f=user&m=updateuser&id=<?php echo $_SESSION['iduser'] ?>"><?php echo $_SESSION['user'] ?></a></div>
        </div>
    </div>
